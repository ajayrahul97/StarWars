...
public class Add extends Activity
	...
	String side, species, gender, lastdate, lastplace, mobno,imageuri;
	ImageView imgview;
	...
	@Override
	public void onClick(View arg0) {
		species = s1.getSelectedItem().toString();
		...
		if (arg0 == b) {
			...
			db.execSQL("INSERT INTO warrior VALUES('" + name.getText() + "','" + side + "','" + species + "','" + gender
					+ "','" + Output.getText().toString() + "','" + lastplace + "','" + number.getText() + "');");
			
			showMessage("Success", "Record added");
			Intent opensp = new Intent(Add.this,Options.class);
