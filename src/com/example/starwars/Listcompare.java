...
public class Listcompare extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<String>(Listcompare.this, android.R.layout.simple_list_item_1, array));
	}
	...
	protected void onListItemClick(ListView l, View v, final int position, long id) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(Listcompare.this);
