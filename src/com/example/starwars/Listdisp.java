...
public class Listdisp extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<String>(Listdisp.this, android.R.layout.simple_list_item_1, array));
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent myintent= new Intent(Listdisp.this, Display.class);
